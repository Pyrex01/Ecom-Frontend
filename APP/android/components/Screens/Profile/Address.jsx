    ...
    return (
        <SafeAreaView>
            ...
            <Icon name='close' color="#000000" size={40} />
                ...
                <View style={{margin:5}}>
                    <View>
                    <TextInput onChangeText={text=>setName(text)} style={{fontSize:20,margin:10}} placeholder='Enter Name for your address' />
                    ...
                    <View>
                    <TextInput onChangeText={text=>setPincode(text)} style={{fontSize:20,margin:10}} placeholder='Pincode' />
                    <Text style={{color:"#ff0000"}}>{errlog.pincodeLog}</Text>
                    </View>
                    <View>
                    <TextInput onChangeText={text=>setRegion(text)} style={{fontSize:20,margin:10}} placeholder='Region' />
